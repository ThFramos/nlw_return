...
export function ScreenShotButton({
  ...
  async function handleTakeScreenshot() {
    ...
    const canvas = await html2canvas(document.querySelector('html')!); //seleciona qual elemento será feito o screenshot e o sinal '!' informa que sempre haverá o elemento selecionado, ou seja, nunca será nulo.
